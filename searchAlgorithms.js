...
//Problem 2: Gievn an sorted array of 'n' elements and a target element 't', find the index of 't' in the array. Return -1 if target element not found.
...
//Problem 3: Gievn an sorted array of 'n' elements and a target element 't', find the index of 't' in the array using recursive binary search. Return -1 if target element not found.
// arr = [-5, 2, 4, 6, 10] t= 10 -> should return 2.
...
console.log(recursiveBinarySearch([-5, 2, 4, 6, 10], 10)); // Output: 4    // Big-O = O(logn)
console.log(recursiveBinarySearch([-5, 2, 4, 6, 10], 4));  // Output: 2    // Big-O = O(logn)
console.log(recursiveBinarySearch([-5, 2, 4, 6, 10], 6));  // Output: 3    // Big-O = O(logn)
console.log(recursiveBinarySearch([-5, 2, 4, 6, 10], 2));  // Output: 1    // Big-O = O(logn)
console.log(recursiveBinarySearch([-5, 2, 4, 6, 10], 1));  // Output: -1   // Big-O = O(logn)
